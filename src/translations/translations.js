const translations = {
  English: {
    ...
    thankYouMessage:
      "We have received your details. We will contact you as soon as possible.",
    goHome: "Go to Home",

    //Farm Details Page Error
  ...
  Telugu: {
    ...
    thankYouMessage: "మీ వివరాలు అందాయి. త్వరలో మేము మిమ్మల్ని సంప్రదిస్తాము.",
    goHome: "హోమ్‌కు వెళ్ళండి",

    //Farm Details Page Error
    nameRequired: "పేరు తప్పనిసరి",
    phoneRequired: "ఫోన్ నంబర్ తప్పనిసరి",
    phoneInvalid: "ఫోన్ నంబర్‌లో సంఖ్యలు మాత్రమే ఉండాలి",
    phoneLength: "ఫోన్ నంబర్ 10 అంకెలు ఉండాలి",
    villageRequired: "గ్రామం పేరు తప్పనిసరి",
    districtRequired: "జిల్లా తప్పనిసరి",
  ...
  Kannada: {
    ...
    thankYouMessage:
      "ನಿಮ್ಮ ವಿವರಗಳನ್ನು ನಾವು ಸ್ವೀಕರಿಸಿದ್ದೇವೆ. ಶೀಘ್ರದಲ್ಲೇ ನಿಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸುತ್ತೇವೆ.",
    goHome: "ಮುಖಪುಟಕ್ಕೆ ಹೋಗಿ",

    //Farm Details Page Error
    nameRequired: "ಹೆಸರು ಅಗತ್ಯವಿದೆ",
    phoneRequired: "ದೂರವಾಣಿ ಸಂಖ್ಯೆ ಅಗತ್ಯವಿದೆ",
    phoneInvalid: "ದೂರವಾಣಿ ಸಂಖ್ಯೆ ಸಂಖ್ಯೆಗಳು ಮಾತ್ರ ಇರಬೇಕು",
    phoneLength: "ದೂರವಾಣಿ ಸಂಖ್ಯೆ 10 ಅಂಕೆಗಳಿರಬೇಕು",
    villageRequired: "ಹಳ್ಳಿಯ ಹೆಸರು ಅಗತ್ಯವಿದೆ",
